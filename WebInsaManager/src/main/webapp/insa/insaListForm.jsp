...
<div class="m-5 bt-5">
	...
	<form class="row pb-3" id="getInsaListForm" action="/biz/insa/insaListForm.do" method="post">
		<div class="row border m-3 pb-3">
			...
			<div class="col-md-3">
				...
				<select name="join_yn" id="join_yn" class="form-select form-control form-control-sm">
			...
			<div class="col-md-3">
				...
				<select name="put_yn" id="put_yn" class="form-select form-control form-control-sm">
					<option selected></option>
					<option value="Y">Y</option>
					<option value="N">N</option>
				</select>													
		...
		<div class="row border m-3 pb-3">
			<div class="col-md-3">
				...
				<select name="pos_gbn_code" id="pos_gbn_code" class="form-select form-control form-control-sm">
					<option selected></option>
	...
	<div class="table-responsive" id="getInsaList">	
