...
<table class="table table-hover">
	...
	<tr>
		...
		<td><div class="form-inline form-group">				
				<input type="text" name="reg_no1" id="reg_no1" maxlength="6" 
					onkeyup="reg_no_check(this.value, this)" style="width:100px"
					class="form-control form-control-sm">
				<label>-</label>
				...
				<input type="password" name="reg_no3" id="reg_no3" style="width:100px"
					maxlength="6" onkeyup="reg_no_check(this.value, this)"
					class="form-control form-control-sm"></div></td>
		<td>전화번호</td>
		<td><input type="text" name="phone" id="phone" maxlength="13"
				onkeyup="phone_check(this.value)" class="form-control form-control-sm"></td>
		<td>핸드폰번호</td>
		<td><input type="text" name="hp" id="hp" maxlength="13"
				onkeyup="hp_check(this.value)" class="form-control form-control-sm"></td>
	</tr>	
	<tr>
		<td>연령</td>
		<td><input type="text" name="age" id="age" maxlength="3"
				onkeyup="age_check(this.value)"  class="form-control form-control-sm"></td>
	...
	<tr>
		...
		<td><input type="text" style="text-align:right" name="salary_str" placeholder="(만원)" 
				id="salary" onkeyup="numberWithCommas(this.value)" 
				 class="form-control form-control-sm"></td>
	...
	<tr>
		...
		<td><input type="text" name="cmp_reg_no" id="cmp_reg_no" maxlength="11" 
				onkeyup="cmp_reg_no_check(this.value)"  class="form-control form-control-sm"></td>
		<td>업체명</td>
