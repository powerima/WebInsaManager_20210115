		...
		<form class="row" name="inputForm" action="/biz/insa/insaInputForm.do" method="post"
			...
			<div class="border row">
				<div class="col-md-12">			
					...
					<input type="submit" class="btn btn-primary btn-sm float-end m-1" value="전화면">					
				...
				<div class="row col-md-10">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-12">
							<label for="reg_no" class="form-control-sm" >주민등록번호</label>
						...
						<div class="col-md-1 col-sm-12">					
							<label for="age" class="form-control-sm">연령</label> 
							<input type="text" name="age" id="age" oninput="age_check(this)"
								class="form-control form-control-sm">				
						</div>
						<div class="col-md-1 col-sm-12">
							<label for="sex" class="form-control-sm">성별</label> 
			...
			<div class="border-start border-end border-bottom row">
				<div class="col-md-3">
					...
					<div class="input-group">
						<input type="text" name="zip" class="form-control form-select-sm"
				...
				<div class="col-md-3">
					<label class="form-control-sm" or="join_yn">입사구분</label> 
			...
			<div class="border-start border-end border-bottom row">
				...
				<div class="col-md-3">
					<label class="form-control-sm" for="mil_enddate">전역일자</label> 
					<div class="form-inline ">
