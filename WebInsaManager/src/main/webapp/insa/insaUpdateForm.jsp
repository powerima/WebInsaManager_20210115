...
<div class="m-5 bt-5">
	...
	<form class="row" name="inputForm" action="/biz/insa/insaInputForm.do" method="post"
		...
		<div class="row border m-3">
			<div class="col-md-12">			
				<button type="reset" class="btn btn-primary btn-sm float-end m-1">리셋</button>
				<button type="submit" class="btn btn-primary btn-sm float-end m-1">전화면</button>					
				<button type="button" class="btn btn-primary btn-sm float-end m-1" id="insaInputAjax">등록</button>
			</div>
		</div>
		<div class="border m-3 pb-3">
			<div class="p-2 bg-light border col-md-3">
	 			<img src="../file/profile_empty.jpg" alt="Generic placeholder image" />
	 		</div>
	 		<div class="p-1 bg-light border col-md-3 form-control-sm">
			...
			<div class="col-md-4">
				...
				<div class="input-group" id="input-group-email">
					<input type="text" name="email_id"
						class="form-control form-control-sm">
					<span class="form-control-sm">@</span>
					<select name="email_domain1" class="form-control form-control-sm" id="email_domain1">
						<option selected>선택</option>
