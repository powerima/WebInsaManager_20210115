...
<div class="m-5">
	...
	<form class="row pb-3 form-control-sm" id="getInsaListForm" action="/biz/insa/insaListForm.do" method="post">
		<div class="row border-top border-start border-end ">
			<div class="col-md-3">
				<label class="form-control-sm" for="sabun">사번</label> 
				<input type="number" class="form-control form-select-sm" name="sabun"
			...
			<div class="col-md-3">
				...
				<select name="join_yn" id="join_yn" class="form-select form-control form-select-sm">
			...
			<div class="col-md-3">
				...
				<select name="put_yn" id="put_yn" class="form-select form-control form-select-sm">
					<option selected></option>
					<option value="Y">Y</option>
					<option value="N">N</option>
				</select>													
		...
		<div class="row border-bottom border-start border-end ">
			<div class="col-md-3">
				...
				<select name="pos_gbn_code" id="pos_gbn_code" class="form-select form-control form-select-sm">
					<option selected></option>
	...
	<div class="container-md">
		<div class="justify-content-center">
			<div class="table-responsive form-control-sm" id="getInsaList">	
