...
public class InsaVo {
	...
	public String toString() {
		return "InsaVo [sabun=" + sabun + ", join_day=" + join_day + ", retire_day=" + retire_day + ", put_yn=" + put_yn
				...
				+ ", sex=" + sex + ", age=" + age + ", email=" + email + ", email_id=" + email_id + ", email_domain1="
				+ email_domain1 + ", email_domain2=" + email_domain2 + ", zip=" + zip + ", addr1=" + addr1 + ", addr2="
				+ addr2 + ", dept_code=" + dept_code + ", join_gbn_code=" + join_gbn_code + ", id=" + id + ", pwd="
				+ pwd + ", salary=" + salary + ", salary_str=" + salary_str + ", kosa_reg_yn=" + kosa_reg_yn
